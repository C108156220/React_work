...
$allUsers = mysqli_query($db_connection, "SELECT EmpId as id, EmpName as user_name, JobTitle as user_job, phone, DeptName as dept_name, City as city  FROM employee, dept  WHERE employee.DeptId=dept.DeptId");
