...
const UserList = () => {
  ...
  const enableEdit = (id, user_name, user_job) => {
    setNewData({ id, user_name, user_job });
    editMode(id);
  };
  ...
  return !userLength ? (
    ...
    <table>
      ...
      <tbody>
        {users.map(({ id, user_name, user_job, isEditing }) => {
          return isEditing === true ? (
            <tr key={id}>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => updateNewData(e, "user_job")}
                />
              </td>
              <td>
            ...
            <tr key={id}>
              ...
              <td>
                <button
                  className="btn default-btn"
                  onClick={() => enableEdit(id, user_name, user_job)}
                >
                  Edit
                </button>
                <button
